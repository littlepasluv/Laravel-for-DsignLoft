            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-lg font-medium mb-4">Active Briefs</h3>
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <div v-if="allBriefs.length === 0" class="text-gray-500 text-center py-8">
                            No briefs available.
                        </div>

                        <div v-else class="space-y-4">
                            <div 
                                v-for="brief in allBriefs" 
                                :key="brief.id"
                                class="border rounded-lg p-4"
                            >
                                <div class="flex justify-between items-start">
                                    <div>
                                        <h4 class="font-semibold">{{ brief.title }}</h4>
                                        <p class="text-gray-600 text-sm mt-1">{{ brief.description }}</p>
                                        <div class="mt-2 flex items-center space-x-4">
                                            <span class="text-sm text-gray-500">
                                                Client: {{ brief.creator.name }}
